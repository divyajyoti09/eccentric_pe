...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mass1:19.4444 mass2:15.5556 mchirp:15.1215 eta:0.2469 mtotal:35 q:1.25 \
...
echo "plotting mchirp, q, and chi_eff..."

pycbc_inference_plot_posterior \
    --input-file posterior.hdf \
    --output-file posterior_Mc_q_chieff.png \
    --parameters mchirp q chi_eff \
    --expected-parameters mchirp:15.1215 q:1.25 chi_eff:0.3\
    --plot-prior config.ini\
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
