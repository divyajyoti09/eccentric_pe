...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:40.0 mass2:8.0 mchirp:14.6839 eta:0.1389 mtotal:48.0 q:5.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:14.6839 q:5.0 chi_eff:0.3 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.3 spin2_a:0.3 spin1_azimuthal:0.0 spin2_azimuthal:0.0 spin1_polar:0.0 spin2_polar:0.0 chi_eff:0.3 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
