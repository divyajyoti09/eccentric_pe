...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:69.6 mass2:46.4 mchirp:49.2702 eta:0.24 mtotal:116.0 q:1.5 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:49.2702 q:1.5 chi_eff:0.2033 chi_p:0.4217 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.469 spin2_a:0.2236 spin1_azimuthal:1.0744 spin2_azimuthal:0.4058 spin1_polar:1.1179 spin2_polar:0.4586 chi_eff:0.2033 chi_p:0.4217 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
