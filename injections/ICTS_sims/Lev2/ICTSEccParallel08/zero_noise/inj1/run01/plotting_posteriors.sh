...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:75.0 mass2:15.0 mchirp:27.5323 eta:0.1389 mtotal:90.0 q:5.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:27.5323 q:5.0 chi_eff:0.05 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.1 spin2_a:0.2 spin1_azimuthal:0.0 spin2_azimuthal:0.0 spin1_polar:0.0 spin2_polar:3.1416 chi_eff:0.05 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
