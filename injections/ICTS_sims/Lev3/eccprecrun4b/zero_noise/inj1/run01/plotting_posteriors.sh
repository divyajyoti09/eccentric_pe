...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:20.0 mass2:10.0 mchirp:12.1673 eta:0.2222 mtotal:30.0 q:2.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:12.1673 q:2.0 chi_eff:0.2342 chi_p:0.1409 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.245 spin2_a:0.4242 spin1_azimuthal:0.8895 spin2_azimuthal:0.1746 spin1_polar:0.613 spin2_polar:0.7788 chi_eff:0.2342 chi_p:0.1409 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
