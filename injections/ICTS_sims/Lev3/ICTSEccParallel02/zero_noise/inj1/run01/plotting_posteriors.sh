...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:20.0394 q:2.5 chi_eff:0.0 chi_p:0.4123 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.4123 spin2_a:0.4123 spin1_azimuthal:4.6068 spin2_azimuthal:1.6277 spin1_polar:1.5685 spin2_polar:1.5765 chi_eff:0.0 chi_p:0.4123 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
