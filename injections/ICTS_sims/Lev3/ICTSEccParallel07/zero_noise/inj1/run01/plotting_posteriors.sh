...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:88.8889 mass2:11.1111 mchirp:24.9323 eta:0.0988 mtotal:100.0 q:8.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:24.9323 q:8.0 chi_eff:0.4222 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.5 spin2_a:0.2 spin1_azimuthal:0.0 spin2_azimuthal:3.1416 spin1_polar:0.0 spin2_polar:3.1416 chi_eff:0.4222 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
