...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:44.9167 mass2:4.0833 mchirp:10.4716 eta:0.0764 mtotal:49.0 q:11.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:10.4716 q:11.0 chi_eff:-0.35 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.4 spin2_a:0.2 spin1_azimuthal:3.1416 spin2_azimuthal:0.0 spin1_polar:3.1416 spin2_polar:0.0 chi_eff:-0.35 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
