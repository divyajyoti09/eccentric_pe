...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:11.0268 q:9.5 chi_eff:0.3 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.3 spin2_a:0.3 spin1_azimuthal:3.1416 spin2_azimuthal:3.1416 spin1_polar:0.0 spin2_polar:0.0 chi_eff:0.3 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
