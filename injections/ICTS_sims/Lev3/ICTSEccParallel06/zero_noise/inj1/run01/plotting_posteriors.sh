...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:99.9 mass2:11.1 mchirp:26.1739 eta:0.09 mtotal:111.0 q:9.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:26.1739 q:9.0 chi_eff:-0.1674 chi_p:0.318 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.3741 spin2_a:0.1 spin1_azimuthal:5.192 spin2_azimuthal:2.9046 spin1_polar:2.1257 spin2_polar:0.0605 chi_eff:-0.1674 chi_p:0.318 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
