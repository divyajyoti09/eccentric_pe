...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mass1:78.5556 mass2:22.4444 mchirp:35.2296 eta:0.1728 mtotal:101 q:3.5 \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mchirp:35.2296 q:3.5 chi_eff:0.0018\
    --plot-prior config.ini\
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters spin1z:0.0018 spin2z:0.0018 chi_eff:0.0018 \
    --plot-prior config.ini\
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
