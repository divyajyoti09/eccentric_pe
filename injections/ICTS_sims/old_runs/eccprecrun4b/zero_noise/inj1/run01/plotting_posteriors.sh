...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mass1:20 mass2:10 mchirp:12.1673 eta:0.2222 mtotal:30 q:2 \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mchirp:12.1673 q:2 chi_eff:0.2 chi_p:0.1409 \
    --plot-prior config.ini \
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters spin1_a:0.245 spin1_azimuthal:0.8895 spin1_polar:0.6130 spin2_a:0.245 spin2_azimuthal:0.8895 spin2_polar:0.6130 chi_eff:0.2 chi_p:0.1409 \
    --plot-prior config.ini \
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
