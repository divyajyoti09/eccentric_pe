...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mass1:29.2857 mass2:11.7143 mchirp:15.8003 eta:0.2041 mtotal:41 q:2.5 \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mchirp:15.8003 q:2.5 chi_eff:0.0 chi_p:0.4123 \
    --plot-prior config.ini \
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters spin1_a:0.4123 spin1_azimuthal:4.4674 spin1_polar:1.5708 spin2_a:0.4123 spin2_azimuthal:1.3258 spin2_polar:1.5708 chi_eff:0.0 chi_p:0.4123 \
    --plot-prior config.ini \
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
