...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:49.7619 mass2:5.2381 mchirp:12.6348 eta:0.0862 mtotal:55.0 q:9.5 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:12.6348 q:9.5 chi_eff:-0.5714 eccentricity:0.1 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1z:-0.6 spin2z:-0.3 chi_eff:-0.5714 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
