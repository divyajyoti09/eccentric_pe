...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:37.313 q:2.0 chi_eff:0.3334 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.4 spin2_a:0.2 spin1_azimuthal:0.0 spin2_azimuthal:3.1416 spin1_polar:0.0 spin2_polar:0.0 chi_eff:0.3334 chi_p:0.0 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
