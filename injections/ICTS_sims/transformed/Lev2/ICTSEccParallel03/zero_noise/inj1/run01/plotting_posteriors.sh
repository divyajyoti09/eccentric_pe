...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:35.2296 q:3.5 chi_eff:0.0025 chi_p:0.2236 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.2236 spin2_a:0.2236 spin1_azimuthal:0.7279 spin2_azimuthal:1.2285 spin1_polar:1.5626 spin2_polar:1.5487 chi_eff:0.0025 chi_p:0.2236 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
