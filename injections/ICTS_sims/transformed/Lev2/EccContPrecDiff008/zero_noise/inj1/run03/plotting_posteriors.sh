...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mass1:20.0 mass2:20.0 mchirp:17.411 eta:0.25 mtotal:40.0 q:1.0 \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters mchirp:17.411 q:1.0 chi_eff:0.0013 chi_p:0.5 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
...
pycbc_inference_plot_posterior \
	...
	--expected-parameters spin1_a:0.5 spin2_a:0.0 spin1_azimuthal:1.1564 spin2_azimuthal:3.1416 spin1_polar:1.5655 spin2_polar:0.0 chi_eff:0.0013 chi_p:0.5 \
	--plot-prior complete_config.ini \
	--plot-contours \
	--plot-scatter \
	--plot-marginal \
