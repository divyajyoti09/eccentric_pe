...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mass1:64.1667 mass2:45.8333 mchirp:47.0778 eta:0.2430 mtotal:110 q:1.4 \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters mchirp:47.0778 q:1.4 chi_eff:-0.5 chi_p:0.0 \
    --plot-prior config.ini \
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
...
pycbc_inference_plot_posterior \
    ...
    --expected-parameters spin1_a:0.4999 spin1_azimuthal:3.1416 spin1_polar:3.1416 spin2_a:0.4999 spin2_azimuthal:3.1416 spin2_polar:3.1416 chi_eff:-0.5 chi_p:0.0 \
    --plot-prior config.ini \
    --plot-contours \
    --plot-scatter \
    --plot-marginal \
